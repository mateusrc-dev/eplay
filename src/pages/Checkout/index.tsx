...
const Checkout = () => {
  ...
  const getErrorMessage = (fieldName: string, message?: string) => {
    const isTouched = fieldName in form.touched // 'in' for verify if the property exist in object
  ...
  return (
    <form onSubmit={form.handleSubmit} className="container">
      ...
      <Card title="Pagamento">
        <>
          <TabButton
            onClick={() => setPayWithCard((prevState) => !prevState)}
                ...
                <Row marginTop="24px">
                  <InputGroup maxWidth="150px">
                    ...
                    >
                      ...
                      <option value="">2x de R$ 200</option>
                      <option value="">3x de R$ 200</option>
                    </select>
                    <small>
                      {getErrorMessage(
                        'installments',
